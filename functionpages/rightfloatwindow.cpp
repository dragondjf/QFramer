...
void RightFloatWindow::showEvent(QShowEvent *event)
{
    ...
    MainWindow::getInstance()->getSettingMenu()->getActionMaps()["Show rightBar"]->setText(tr("Hide rightBar"));
...
{
    Q_UNUSED(event)
    MainWindow::getInstance()->getSettingMenu()->getActionMaps()["Show rightBar"]->setText(tr("Show rightBar"));
}
