// ttsdemo_with_tune.c : Defines the entry point for the console application.
	//
#include "stdlib.h"
#include "stdio.h"
#include <windows.h>
...
int main(int argc, char* argv[])
	{
		...
		const char* text  = "讯飞语音，沟通无限。";//待合成的文本
		const char*  filename = "text_to_speech_test_withspeechmark.pcm";//合成的语音文件
		const char* param = "bgs=1, spd = 50, vol = 50, smk=3";//带参数smk=3，获取详细的语音标注，json格式，请自行解析
		int ret = 0;
		char key = 0;
